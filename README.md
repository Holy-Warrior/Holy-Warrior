...
I'm a Software Engineering student who ended up comfortable across more stacks than I planned on — Flutter for mobile, Laravel/PHP and JS for the web, and lately Rust + Tauri for desktop. I pick the tool the project actually needs rather than sticking to one lane, and I fold in Generative AI when it genuinely improves what I'm building, not just for the sake of it.

- 🎓 BS in Software Engineering @ Sarhad University of Science and Information Technology, Peshawar
- 🧠 Final Year Project: **DeenLab** — an Islamic utility app with an on-device ML engine (Human Activity Recognition) that auto-silences your phone during prayer
- 🛠️ Currently building **Comic Tracker**, my first Rust/Tauri v2 desktop app
- 🌱 Learning: systems-level programming, on-device ML deployment
- 📫 Reach me: **cutexcoder@gmail.com** · [LinkedIn](https://linkedin.com/in/hamza-bin-zafar-cutexcoder)
...
**[DeenLab](https://github.com/Holy-Warrior/deen_lab)** 🕌 · Final Year Project
Islamic utility app (prayer times, Qibla, Quran/Hadith) with a custom on-device HAR engine that auto-silences the phone during prayer. Originally prototyped in .NET MAUI, rebuilt in Flutter after MAUI struggled with long-running background SQLite writes.
`Flutter` `Android-native` `On-device ML` `SQLite`
...
**[Zenix Travel Companion](https://github.com/Holy-Warrior/Zenix_Travel_Companion)** ✈️
AI travel planning assistant built with a team of 4 for the HEC / Pak Angels Generative AI Hackathon. Generates itineraries, packing lists, and local tips.
`Python` `Gradio` `Hugging Face Spaces` — [Live Demo](https://huggingface.co/spaces/TayyabKhalid/Zenix_Travel_Companion)

</td>
<td width="50%" valign="top">

**[Online Voting System](https://github.com/Holy-Warrior/online-voting-system)** 🗳️
Full-stack voting platform with auth, one-vote-per-user enforcement, real-time results, and an admin dashboard.
...
- Programming Hero: C Programming
- Programming Hero: Python Programming

<br>

<div align="center">

![Profile Views](https://komarev.com/ghpvc/?username=Holy-Warrior&color=6C5B9E&style=flat)
